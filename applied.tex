...
%TODO Atreas Graph 17
  ...
  \end{enumerate}
    ...
    \Aboxed{
    	\Phi &= \frac{5}{\pi}\mathsmaller{\mathsmaller{\arctan\left(
    	\sinh(\pi y)\cos(\pi x),\sin(\pi x)\cosh(\pi y) + 1
    	\right)}} - \frac{10}{\pi}\mathsmaller{\arctan\left(
    	\sinh(\pi y)\cos(\pi x),\sin(\pi x)\cosh(\pi y) - 1
    	\right)} + 10
    	}
    \end{align*}
