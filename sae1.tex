...
\begin{gather*}
	...
	\frac{16}{6}\left(
	    \frac{Δ_z}{2+Δ_z}e^{-2t} + \left(\frac{Δ_z}{6} - 1\right)e^{-8t}
	\right)
\end{gather*}
...
Στην ουσία δηλαδή, το μηδανικό στη θέση \( -(2+Δ_z) \to -2 \) ακυρώνει τον πόλο \( s=-2 \):
\todo{Graph 63}
...
Άρα η σωστή απάντηση είναι η \textbf{(b)}.
...
\paragraph{Άσκηση}
Ποιά συνάρτηση μοιάζει με την παραπάνω απόκριση;
\todo{Graph 66}
\todo{EXPLAIN!}
...
Η σωστή απάντηση είναι η \textbf{(d)}.
...
Θυμόμαστε επίσης ότι για μεγαλύτερο \( \omega_d \), έχουμε μικρότερο χρόνο ανόδου \( t_r \).

Η ταχύτητα ανόδου εξαρτάται από τον χρόνο ανόδου, και το πόσο έχει ανεβεί η τιμή της
συνάρτησης μέσα σε αυτόν τον χρόνο:
\todo{Graph 67}

Η σωστή απάντηση είναι η \textbf{(δ)}, επειδή φτάνει τη μεγαλύτερη τιμή σε μικρότερο χρόνο,
λόγω του μηδενικού.
Η (γ) έχει dc κέρδος \( \mathrm{d_c} = \frac{10}{14} \), και η (δ) έχει \( \mathrm{d_c} = \frac{3}{14} \), ενώ οι (α) και (β) έχουν μικρότερο \( \omega_d \), άρα μεγαλύτερο χρόνο
ανόδου.
...
\draw[->] (0,-2.2) -- ++(6,0) node[right] {$\omega$};
