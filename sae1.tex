...
τόπων, ακολουθούμε μερικούς κανόνες:
\begin{itemize}
	...
	\end{align*}
	\item
	Για να βρούμε τα σημεία στα οποία αλλάζει πορεία ο γεωμετρικός τόπος, βρίσκουμε τη λύση της παραγώγου:
	\[
	\od{H_p(s)}{s} = 0
	\]
	...
	\( s^2+40s+200 =0 \), άρα \( s = -5.35 \) και \( s=-34.14 \)
