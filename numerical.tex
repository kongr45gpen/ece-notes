...
\begin{document}
	...
	%TODO Papalamprou Graph 7
	
	%TODO Papalamprou Graph 8
	...
	\begin{align*}
	P_n(x) &= l_0f(x)+l_1(x)f(x_1)+l_2(x)f_2(x) \\
	...
	\paragraph{Άσκηση}
	Να γίνει βρεθεί η τιμή \( f(0.5) \) (intrapolation)
