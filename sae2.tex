...
σε αυτό ( \( \left|x_0-x^*\right| < \delta \) ). Δηλαδή, για να ικανοποιείται ο ορισμός, θα
πρέπει και το σημείο που φτάνουμε \( x(t; x_0) \) να είναι αρκετά κοντά στο σημείο ισορροπίας
\( x^* \).

Ο παραπάνω ορισμός εκφράζει την έννοια της ευστάθειας του \textbf{σημείου ισορροπίας}, όχι ολόκληρου του συστήματος.
