...
%		}
    ...
    \begin{align*}
    	F_X(Y=y) &= \frac{
    		...
    		\sfrac{\partial F_{Y}(x,y)  }{\partial y} } = \frac{\int_{-\infty}^{X} f(x,y)\dif x}{f_{y}(y)} \\
    	f_x(x/Y=y) &= \frac{f(x,y)}{f_{y}(y)} = \frac{f(x,y)}{\int_{-\infty}^{\infty} f(x,y)\dif x}
    \end{align*}
