...
Να σημειωθεί πως το γεγονός ότι υπάρχουν και τιμές στον πραγματικό
άξονα, δεν σημαίνει ότι το σήμα δεν υφίσταται στην πραγματικότητα,
αλλά ότι περιέρχει και δεδομένα στην φάση του!
...
\todo{Graph 44}
που με ένα απλό Low Pass Filter μάς δίνουν το αρικό ακουστικό σήμα.
